...
module.exports = function (orgId) {
  ...
  return [
    ...
    'FROM (',
      'SELECT challenges.title AS chal_title, challenges.id AS chal_id, challenges.description AS chal_description, tags.name AS tag_name, tags.id AS tag_id, tags.active AS tag_active, challenges.active AS chal_active',
      'FROM CHALLENGES',
