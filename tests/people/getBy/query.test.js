...
var expectedGetById = 'SELECT id, first_name, last_name, user_type, email, '
  + 'phone, password, job_title, last_login, logo_url, active, org_id, notification_email, account_activated FROM '
  + 'people WHERE id = 1;';
...
var expectedGetByEmail = 'SELECT id, first_name, last_name, user_type, email, '
  + 'phone, password, job_title, last_login, logo_url, active, org_id, notification_email, account_activated '
